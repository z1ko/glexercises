...
int main(int argc, char **argv) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // Update uniform mixer
    offset = 0.5f + sinf(elapsed * 0.5f) * 0.25f;
    glib::program_uniform_1f(program, "mixer", offset);
