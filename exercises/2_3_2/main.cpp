...
int main(int argc, char** argv) {
  ...
  while(!glfwWindowShouldClose(window)) {
    ...
    glib::program_uniform_3f(program, "material.ambient",   0.0f, 0.1f, 0.06f);
    glib::program_uniform_3f(program, "material.diffuse",   0.0f, 0.50980392f, 0.50980392f);
    glib::program_uniform_3f(program, "material.specular",  0.50196078f, 0.50196078f, 0.50196078f);
    ...
    glib::program_uniform_3f(program, "light.ambient",  1.0f, 1.0f, 1.0f);
    glib::program_uniform_3f(program, "light.diffuse",  1.0f, 1.0f, 1.0f);
    ...
    glib::program_uniform_3f(light_program, "light.ambient", 1.0f, 1.0f, 1.0f);
